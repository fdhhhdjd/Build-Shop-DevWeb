...
export declare function pollingMonitorWithTokenUntilDone(token: string, isAsync: boolean, options: Options, pollInterval: number, attemptsCount: number, maxAttempts: number | undefined, resolutionMeta: ResolutionMeta | undefined): Promise<MonitorDependenciesResponse>;
